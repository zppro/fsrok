...
(function() {
    ...
    angular
        ...
        .controller('ReceptionManageGridController', ReceptionManageGridController)
        .controller('ReceptionManageDetailsController', ReceptionManageDetailsController)
    ;


    ReceptionManageGridController.$inject = ['$scope', 'ngDialog', 'vmh', 'entryVM'];

    function ReceptionManageGridController($scope, ngDialog, vmh, vm) {
        $scope.vm = vm;
    ...
    ReceptionManageDetailsController.$inject = ['$scope', 'ngDialog', 'vmh', 'entityVM'];

    function ReceptionManageDetailsController($scope, ngDialog, vmh, vm) {
        ...
        function doSubmit() {
            ...
            if ($scope.theForm.$valid) {
                vm.save(true).then(function(ret){
                    vmh.pftaOrgService.receptionVisiterSyncElderlyFamilyMembers(vm.model._id||ret._id).then(function (ret) {
